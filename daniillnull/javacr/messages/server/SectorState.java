...
public class SectorState extends Packet {
   ...
   public void process() throws IOException {
      ...
      d.write(new byte[]{15, (byte)this.location, 18, 40, 54, 0});
      d.write(127);
      d.write(127);
      d.write(encodeVInt(0));
      d.write(encodeVInt(this.own.id));
      ...
      for(int i = 0; i < this.own.deck.length; ++i) {
      ...
      end.write(new byte[]{1, -91, 3, 0, 0});
      end.write(b.toByteArray());
      this.data = end.toByteArray();
   }
}
